...
public class JwtManager implements Serializable {
    ...
    private Claims getAllClaimsFromToken(String token) {
        return Jwts.parser().setSigningKey(jwtProvider.getSecret().getBytes()).parseClaimsJws(token).getBody();
    }
    ...
    private String doGenerateToken(Map<String, Object> claims, String subject) {
        return Jwts.builder()
                ...
                .setExpiration(new Date(System.currentTimeMillis() + jwtProvider.getExpiration() * 1000))
